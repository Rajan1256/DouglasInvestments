...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.investCompany.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.invest-companies.update', [$investCompany->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('investment_company') ? 'is-invalid' : '' }}" type="text"
                        name="investment_company" id="investment_company"
                        value="{{ old('investment_company', $investCompany->investment_company) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('investment_short_code') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('investment_short_code', $investCompany->investment_short_code) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('investment_description') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('investment_description', $investCompany->investment_description) }}" >
