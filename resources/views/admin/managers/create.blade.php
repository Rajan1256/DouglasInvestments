...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.managers.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="profile_images" class="required">Profile Image</label>
                <input class="form-control {{ $errors->has('profile_images') ? 'is-invalid' : '' }}" type="file" name="profile_images" id="profile_images" value="{{ old('profile_images', '') }}" required>
