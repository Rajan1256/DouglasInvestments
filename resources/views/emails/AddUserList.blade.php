                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <tr>
                        <th>Client Code</th>
                        <th style="padding:10px;">Sharepoint Folder Name</th>
                        </tr>
                      
                        @foreach($mailData['data_first'] as $rw)
                        <tr>
                          <td>
                          {{$rw->client_code}}
                          </td>
                          <td style="padding:10px;">
                          {{$rw->Sharepoint_folder_name}}
                          </td>
                        </tr>
                        @endforeach
                      </table>
                  ...
                  <tr>
                    ...
                    >
                      <table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <th>Client Code Required</th>
                        <th style="padding:10px;">Suggested Sharepoint Folder Name</th>
                        </tr>
                      
                        @foreach($mailData['data_second'] as $rw)
                        <tr>
                          <td>
                          {{$rw->client_code}}
                          </td>
                          <td style="padding:10px;">
                          {{$rw->db_client_folder_name}}
                          </td>
                        </tr>
                        @endforeach
                      </table>
